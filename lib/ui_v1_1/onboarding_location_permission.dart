...
import 'package:corona_trace/ui_v1_1/onboarding_notification_permission.dart';
...
class OnboardingLocationPermissionState
    extends BaseState<OnboardingLocationPermission> {
  
  @override
  String screenName() {
    return "onboarding_location_permission";
  }
        ...
        children: <Widget>[
          ...
          Container(
            child: Column(
              ...
              children: <Widget>[
                Text(
                  AppLocalization.text("onboarding.permissions.location.title"),
                  style: TextStyle(
                      fontSize: 28,
                ...
                Text(AppLocalization.text("onboarding.permissions.location.subtitle"),
