...
import 'package:corona_trace/ui_return_safe_demo/home_checkin/home_checkin_dashboard.dart';
...
class AtRiskNotificationDetail extends StatelessWidget {
  ...
  Row getNextSteps() {
    return Row(
      ...
      children: <Widget>[
        RawMaterialButton(
          fillColor: Color(0xff379FFF),
          onPressed: () {},
          child: Icon(
            Icons.arrow_forward,
            color: Colors.white,
          ),
          shape: CircleBorder(side: BorderSide(color: Color(0xff379FFF))),
        ),
        Text(
